...
impl TendermintInner {
    ...
    fn verify_block_external(&self, header: &Header) -> Result<(), Error> {
        ...
        for rlp in UntrustedRlp::new(precommits_field).iter() {
            ...
            // This message is a dummy message to check address. signer_index value does not affect.
            ...
            if !verify_schnorr(&public, &precommit.signature, &precommit_hash)? {
